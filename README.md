...
*Updated in July 2026 to deliver training online*

This github repository contains the materials you will need to go
through the training examples for yourself.
...
help during the session. R is essential for the second exercise (for the
